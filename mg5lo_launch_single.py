...
for filename in os.listdir("/tmp/%s/lo_med%s_dm%s_%s_beam%s_n%s_xqcut%s_repeat%s/Events/run_01/"%(username,str(MY1),str(MXd),model,ebeam,nevents,xqcut,repeat_index)):
  if ".pdf" in filename and "hadron" in filename: os.system("cp /tmp/%s/lo_med%s_dm%s_%s_beam%s_n%s_xqcut%s_repeat%s/Events/run_01/%s %s/lo_hadron_MA5_med%s_dm%s_%s_beam%s_n%s_xqcut%s_repeat%s.pdf"%(username,str(MY1),str(MXd),model,ebeam,nevents,xqcut,repeat_index,filename,sdir,str(MY1),str(MXd),model,ebeam,nevents,xqcut,repeat_index))
  if ".pdf" in filename and "parton" in filename: os.system("cp /tmp/%s/lo_med%s_dm%s_%s_beam%s_n%s_xqcut%s_repeat%s/Events/run_01/%s %s/lo_parton_MA5_med%s_dm%s_%s_beam%s_n%s_xqcut%s_repeat%s.pdf"%(username,str(MY1),str(MXd),model,ebeam,nevents,xqcut,repeat_index,filename,sdir,str(MY1),str(MXd),model,ebeam,nevents,xqcut,repeat_index))
os.chdir(odir)
